const int boton1Pin = 11; // Pin digital al que está conectado el botón 1
const int boton2Pin = 12; // Pin digital al que está conectado el botón 2
...
void loop() {
  ...
  if (boton1Estado == HIGH) { // Si se presiona el botón 1
    ...
    tone(buzzerPin, 1000, 100); // Hace sonar el buzzer durante 100 milisegundos a 1000Hz
    delay(100); // Espera un momento para evitar rebotes
  }
  if (Serial.available() > 0) { // Si hay datos disponibles en la consola serial
    ...
    if (valor == '4') {
      digitalWrite(2, HIGH); // Enciende el LED rojo en el pin 3
      digitalWrite(5, HIGH); // Enciende el LED rojo en el pin 3
        digitalWrite(3, LOW); // Apaga el LED verde en el pin 4
        digitalWrite(6, LOW); // Apaga el LED azul en el pin 5
  tone(7, 400); // Tono de 400 Hz
  delay(200); // Mantener el tono durante 200 milisegundos
  noTone(7); // Detener el tono
  delay(200); // Esperar 200 milisegundos antes de continuar
  tone(7, 300); // Tono de 300 Hz
  delay(200); // Mantener el tono durante 200 milisegundos
  noTone(7); // Detener el tono
  delay(200); // Esperar 200 milisegundos antes de continuar
  tone(7, 200); // Tono de 200 Hz
  delay(200); // Mantener el tono durante 200 milisegundos
  noTone(7); // Detener el tono
  delay(200); // Esperar medio segundo antes de repetir todo el proceso
  tone(7, 100); // Tono de 200 Hz
  delay(400); // Mantener el tono durante 200 milisegundos
  noTone(7); // Detener el tono
  delay(500); // Esperar medio segundo antes de repetir todo el proceso
      }
    ...
    if (valor == '5') {
      digitalWrite(5, LOW); // Enciende el LED rojo en el pin 3
        digitalWrite(3, HIGH); // Apaga el LED verde en el pin 4
        digitalWrite(6, LOW); // Apaga el LED azul en el pin 5
      tone(buzzerPin, 1046, 150); // Nota C6 durante 150 milisegundos
  delay(50); // Esperar 50 milisegundos antes de continuar
  tone(buzzerPin, 1318, 150); // Nota E6 durante 150 milisegundos
  delay(50); // Esperar 50 milisegundos antes de continuar
  tone(buzzerPin, 1568, 150); // Nota G6 durante 150 milisegundos
  delay(50); // Esperar 50 milisegundos antes de continuar
  tone(buzzerPin, 2093, 300); // Nota C7 durante 300 milisegundos
  delay(150); // Esperar 150 milisegundos antes de continuar
  tone(buzzerPin, 1568, 150); // Nota G6 durante 150 milisegundos
  delay(50); // Esperar 50 milisegundos antes de continuar
  tone(buzzerPin, 1318, 150); // Nota E6 durante 150 milisegundos
  delay(50); // Esperar 50 milisegundos antes de continuar
  tone(buzzerPin, 1046, 150); // Nota C6 durante 150 milisegundos
  delay(50); // Esperar 50 milisegundos antes de continuar
  noTone(buzzerPin); // Detener la reproducción de tonos
  delay(500); // Esperar medio segundo antes de repetir todo el proceso
  }
}
}
